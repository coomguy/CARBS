...
dotfilesrepo="https://github.com/coomguy/archrice.git"
progsfile="https://raw.githubusercontent.com/coomguy/CARBS/master/progs.csv"
aurhelper="yay"
repobranch="master"
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Coomguy's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-coomguy" 10 60
...
usercheck() {
	! { id -u "$name" >/dev/null 2>&1; } ||
		whiptail --title "WARNING" --yes-button "CONTINUE" \
			--no-button "No wait..." \
			--yesno "The user \`$name\` already exists on this system. CARBS can install for a user already existing, but it will OVERWRITE any conflicting settings/dotfiles on the user account.\\n\\nCARBS will NOT overwrite your user files, documents, videos, etc., so don't worry about that, but only click <CONTINUE> if you don't mind your settings being overwritten.\\n\\nNote also that CARBS will change $name's password to the one you just gave." 14 70
}
...
maininstall() {
	...
	whiptail --title "CARBS Installation" --infobox "Installing \`$1\` ($n of $total). $1 $2" 9 70
	installpkg "$1"
}
